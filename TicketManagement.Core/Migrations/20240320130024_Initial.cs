        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subject = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastResponseTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Escalations_Users_RespondedByUserId",
                        column: x => x.RespondedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Escalations_Users_TriggeredByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperationOldValue = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OperationNewValue = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Escalations_RespondedByUserId",
                table: "Escalations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Escalations_TriggeredByUserId",
                table: "Escalations",
